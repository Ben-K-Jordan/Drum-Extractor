...
with playback) and `bass.mid` — and the drum stem comes back as an engraved
part, shown inline on the mixer and synced to playback:

![The engraved drum part for the demo riff](docs/images/sheet.png)
